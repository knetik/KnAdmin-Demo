...
var injectx = require('gulp-inject');
...
gulp.task('styles', ['clean-styles'], function() {
    ...
    return gulp
        ...
        .pipe(injectx(gulp.src(['./src/client/app/**/**/**/*.less',
            './src/client/styles/less/*.less'], {read: false}), {
...
function startBrowserSync(isDev, specRunner) {
    ...
    if (isDev) {
        gulp.watch(['./src/client/app/**/**/*.less',
                './src/client/styles/less/*.less'], ['styles'])
...
function startTests(singleRun, done) {
    ...
    /** Commented out until there are tests to be ran **/
    //var child;
    //var excludeFiles = [];
